...
const mockBooks = [
  { id: 1, title: 'The Lord of the Rings', author: 'J.R.R. Tolkien', status: 'Read', summary: '', details: '' },
  { id: 2, title: 'The Hitchhiker\'s Guide to the Galaxy', author: 'Douglas Adams', status: 'Read', summary: '', details: '' },
  ...
  { id: 4, title: '1984', author: 'George Orwell', status: 'Read', summary: '', details: '' },
  { id: 5, title: 'Brave New World', author: 'Aldous Huxley', status: 'Read', summary: '', details: '' },
  ...
  { id: 7, title: 'Fahrenheit 451', author: 'Ray Bradbury', status: 'Read', summary: '', details: '' },
  { id: 8, title: 'The Catcher in the Rye', author: 'J.D. Salinger', status: 'Read', summary: '', details: '' },
  ...
  { id: 10, title: 'Pride and Prejudice', author: 'Jane Austen', status: 'Read', summary: '', details: '' },
];
