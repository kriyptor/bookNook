...
const CompletedReadinglist = () => {
  ...
  useEffect(() => {
    async function fetchReadingLists() {
      try {
        ...
        const response = await axios.get(`${BASE_URL}/reading-lists/completed?page=${pagination.currentPage}`, {
          headers: {
  ...
  return (
    <>
      <Container className="my-5">
        <h2 className="mb-4 text-center">Your Completed Reading Lists</h2>
