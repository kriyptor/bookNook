  ...
  useEffect(() => {
    async function fetchReadingLists() {
      try {
        ...
        const response = await axios.get(`${BASE_URL}/reading-lists/in-progress?page=${pagination.currentPage}`, {
          headers: {
...
export default InprogressReadinglist;